...
output_data_dir <- file.path(project_root, "example", "data", "simulation")
output_plots_dir <- file.path(project_root, "example", "plots", "simulation")
...
source(file.path(project_root, "scripts", "07_analisis.R"))
